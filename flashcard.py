...
def start_game():
    ...
    entry_button.place(x=205,y=450)
...
start_label=Label(text="FLASHCARDS",font=("fixedsys",70),bg="#6e17bf",fg="white",pady=90)
start_label.place(x=300,y=100)
start_button=Button(text="START STUDYING",font=("fixedsys",30),command=start_game,bg="#2a19e3",fg="white",anchor=CENTER,padx=99)
start_button.place(x=215,y=450)
window.mainloop() 
